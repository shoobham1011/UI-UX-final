...
const Productcards = ({product}) => {
  ...
  return (
    <div className="group relative">
      <div onClick= {handelDetails} className="w-fill h-96 cursor-pointer overflow-hidden">
        <img className="w-full h-full object-cover group-hover:scale-110 duration-300" src={product.image} alt="productImg"/>
      </div>
